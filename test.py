...
class input_test(object):
    ...
    def pre_render_circle_image(self):
        ...
        self.circle.fill(pygame.Color("magenta"))
        ...
        self.circle.set_colorkey(pygame.Color("magenta"), pygame.RLEACCEL)
    def init(self):
        pygame.init()
        ...
        self.statictext = pygame.Color("#FFFFA0")
        self.dynamictext = pygame.Color("white")
        self.antialias = 1
